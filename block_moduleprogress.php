...
class block_moduleprogress extends block_base {
    ...
    public function get_content() {
        ...
        $leaderboard = $showleaderboard ? $this->get_leaderboard_html((int)$USER->id, $rankingcourses, $maxrows) : '';
        ...
        $this->content->text = '
            <div class="moduleprogress-widget">
                ...
                <div class="moduleprogress-middle">
                ...
                <div class="moduleprogress-right">
 ...
 private function get_leaderboard_html(int $currentuserid, array $courseids, int $maxrows): string {
    ...
    if ($currentrank > 1 && isset($userscores[$currentrank - 2])) {
